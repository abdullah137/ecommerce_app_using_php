...
$get_string = ($_GET['prod']);
$get_product = getSingleProduct($get_string);
...
foreach($get_product as $prod) {
    ...
    $product_desc = stripslashes(htmlspecialchars_decode($prod['prod_desc']));
                               ...
                               ?>
                                ...
                                <div class="single-pro-desc single-pro-desc-no-sidebar">
                                    <div class="single-pro-content">
                                        <h5 class="ec-single-title"><?php echo $product_name; ?></h5>
                                        ...
                                        <div class="ec-single-desc"><?php echo $product_desc; ?></div>
                                        ...
                                        <div class="ec-single-sales">
                                            <div class="ec-single-sales-inner">
                                                ...
                                                <div class="ec-single-sales-progress">
                                                    <span class="ec-single-progress-desc">Hurry up!left <?php echo $random_percent; ?> in
                                                        stock</span>
                                        ...
                                        <div class="ec-single-price-stoke">
                                            ...
                                            <div class="ec-single-stoke">
                                                ...
                                                <span class="ec-single-sku">SKU#: WH<?php echo $random_percent; ?></span>
                                            </div>
                                        </div>
        ...
        <div class="container">
            ...
            <div class="row margin-minus-b-30">
                <!-- Related Product Content -->
                  ...
                  <?php 
                    $get_rand_p = getRandomProducts(4);
                    
                    // 
                    foreach($get_rand_p as $prod) {
                           // Listing all the variables needed for this
                           $product_id = $prod['prod_id'];
                           $product_name = stripslashes(htmlspecialchars_decode($prod['prod_name']));
                           $product_images = $prod['pi_sub_images'];
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                                    <div class="ec-product-inner">
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.html"><?php echo $product_name; ?></a></h5>
                                ...
                                <div class="ec-footer-links">
                                    <ul class="align-items-center">
                                        ...
                                        <li class="ec-footer-link"><span>Call Us:</span><a href="tel:+440123456789">+44
                                                0123 456 789</a></li>
                                        <li class="ec-footer-link"><span>Email:</span><a href="https://loopinfosol.in/cdn-cgi/l/email-protection#82e7fae3eff2eee7c2e7e1afe7efe3ebeeace1edef"><span class="__cf_email__" data-cfemail="674c021f060a170b022702044a020a060e0b4904080a">[email&#160;protected]</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    <?PHP
      ...
      foreach($cats as $cat) {
          ...
          foreach($prods as $prod) {
              ...
              ?>
    <!-- Modal -->
    <div class="modal fade" id="ec_quickview_modal_<?php echo $product_id; ?>" tabindex="-1" role="dialog">
...
<!-- Mirrored from loopinfosol.in/themeforest/ekka-html-v2/ekka-html/product-full-width.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Nov 2021 05:30:45 GMT -->
</html>