...
if(isset($_POST['login_button'])) {
    if($_POST['email'] == "" || $_POST['email'] == NULL || $_POST['pass'] == "" || $_POST['pass'] == NULL) {
        $mmsg = '
        ...
        ';
        // Please let them fill the field
    }else {
        $mmsg = logInUser($_POST['email'], $_POST['pass'], $_GET['ref']);
    }
}else {
    $mmsg = "";
}
                        ...
                        <div class="ec-login-form">
                            <form action="#" method="post">
                                ...
                                <span class="ec-login-wrap ec-login-btn">
                                    <button name="login_button" class="btn btn-primary" type="submit">Login</button>
