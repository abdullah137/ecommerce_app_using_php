...
if(isset($_SESSION['cart'])) {
    ...
    foreach($_SESSION['cart'] as $sub_array) {
        ...
        $totalamount = $totalamount + $sub_array['count'];
    }
}else {
                            ...
                            <div class="ec-sb-block-content">
                                <div class="ec-checkout-summary">
                                    <div>
                                        ...
                                        <span class="text-right">N<?php echo number_format($subtotal,0); ?> </span>
                                    </div>
                                    <div>
                                        <span class="text-left">Delivery Charges</span>
                                        <span class="text-right"><?php echo number_format(150,0); ?></span>
                                    </div>
                                    <div>
                                    ...
                                    <div class="ec-checkout-summary-total">
                                        ...
                                        <span class="text-right">N <?php echo number_format($subtotal+150, 0); ?></span>
                                    </div>
                                </div>
                                <div class="ec-checkout-pro">
                                    ...
                                    <?php if(isset($_SESSION['cart'])) {
                                            ...
                                            foreach($_SESSION['cart'] as $sub_array) {
                                                ...
                                                $total_count = $totalcount + $sub_array['count'];
                                            

                                            // getting the properties of the item
                                            $product_url = $sub_array['url'];
                                            $product_name = $sub_array['name'];
                                            $product_price = $sub_array['price'];
                                            $random_num = rand(300, 500);   
                                            $product_id = $sub_array['id']; 
                                    ?>
                                                ...
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="<?php echo $product_url; ?>"
                                                            alt="Product" />
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="ec-pro-content">
                                                <h5 class="ec-pro-title"><a href="product-details?id=<?php echo $product_id; ?>"><?php  echo $product_name; ?></a></h5>
                                                ...
                                                <span class="ec-price">
                                                    <span class="old-price">N <?php echo number_format($random_num, 0) ?></span>
                                                    <span class="new-price">N <?php echo number_format($product_price, 0); ?></span>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
